...
class _show_historyState extends State<show_history> {
  ...
  Widget build(BuildContext context) {
    ...
    return SafeArea(
        child: Scaffold(
          appBar: AppBar(title: Text("Task History"), actions: [
              Align(
                    ...
                    child: Column(
                      children: [
                        ...
                        const Text(
                          ...
                          style: TextStyle(fontSize: 15,fontStyle: FontStyle.normal,fontWeight: FontWeight.bold),
                        ),
                        const Text(
                          " Add Some Task To Increase Your Productivity !!",
                          style: TextStyle( color: Colors.white ,fontSize: 15,fontStyle: FontStyle.normal,fontWeight: FontWeight.bold),
                        ),
                      ],
                    ),
                  ))),
